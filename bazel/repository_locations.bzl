...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    aws_lc_fips = dict(
        project_name = "AWS-LC (FIPS)",
        project_desc = "FIPS Certified version of AWS-LC",
        project_url = "https://github.com/aws/aws-lc/",
        version = "AWS-LC-FIPS-1.1.0",
        sha256 = "b88ce53790f07b711f4c319afbe1f964cc4ed5569c183e1e50a4c16701813430",
        urls = ["https://github.com/aws/aws-lc/archive/refs/tags/{version}.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
        release_date = "2023-03-28",
        cpe = "N/A",
        license = "Mixed",
        license_url = "https://github.com/aws/aws-lc/blob/{version}/LICENSE",
        strip_prefix = "aws-lc-{version}",
        add_prefix = "aws-lc",
    ),
